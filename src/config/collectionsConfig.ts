...
import type { CollectionsConfig, CollectionConfigEntry, SmartRuleCondition } from '../types.js';
import { loadParsedTaggingSpec, type ParsedTaggingSpec } from './taggingSpecLoader.js';
